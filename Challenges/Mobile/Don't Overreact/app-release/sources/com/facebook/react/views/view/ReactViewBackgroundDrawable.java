...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    private void updatePath() {
        ...
        if (this.mNeedUpdatePathForBorderRadius) {
            ...
            this.mOuterClipPathForBorderRadius.addRoundRect(this.mOuterClipTempRectForBorderRadius, new float[]{f, f, borderRadiusOrDefaultTo, borderRadiusOrDefaultTo, borderRadiusOrDefaultTo4, borderRadiusOrDefaultTo4, f2, f2}, Path.Direction.CW);
            ...
            fArr[6] = Math.max(f2 - (directionAwareBorderInsets.left * 0.5f), directionAwareBorderInsets.left > 0.0f ? f2 / directionAwareBorderInsets.left : 0.0f);
            fArr[7] = Math.max(f2 - (directionAwareBorderInsets.bottom * 0.5f), directionAwareBorderInsets.bottom > 0.0f ? f2 / directionAwareBorderInsets.bottom : 0.0f);
        ...
        if (round > 0 || round3 > 0 || round2 > 0 || round4 > 0) {
            ...
            if (fastBorderCompatibleColorOrZero == 0) {
                ...
                if (round > 0) {
                    float f = (float) i6;
                    float f2 = (float) i7;
                    float f3 = (float) (i6 + round);
                    float f4 = (float) (i7 + round2);
                    int i8 = i7 + height;
                    i3 = i7;
                    drawQuadrilateral(canvas, i2, f, f2, f3, f4, f3, (float) (i8 - round4), f, (float) i8);
                } else {
                    i3 = i7;
                }
                if (round2 > 0) {
                    float f5 = (float) i6;
                    float f6 = (float) i3;
                    float f7 = (float) (i6 + round);
                    float f8 = (float) (i3 + round2);
                    int i9 = i6 + width;
                    drawQuadrilateral(canvas, borderColor2, f5, f6, f7, f8, (float) (i9 - round3), f8, (float) i9, f6);
                }
                if (round3 > 0) {
                    int i10 = i6 + width;
                    float f9 = (float) i10;
                    int i11 = i3 + height;
                    float f10 = (float) (i10 - round3);
                    drawQuadrilateral(canvas, i, f9, (float) i3, f9, (float) i11, f10, (float) (i11 - round4), f10, (float) (i3 + round2));
                }
                if (round4 > 0) {
                    float f11 = (float) i6;
                    int i12 = i3 + height;
                    float f12 = (float) i12;
                    int i13 = i6 + width;
                    float f13 = (float) (i12 - round4);
                    reactViewBackgroundDrawable = this;
                    reactViewBackgroundDrawable.drawQuadrilateral(canvas, borderColor4, f11, f12, (float) i13, f12, (float) (i13 - round3), f13, (float) (i6 + round), f13);
                } else {
                    reactViewBackgroundDrawable = this;
                }
                ...
                if (round > 0) {
                    canvas.drawRect((float) i6, (float) i7, (float) (i6 + round), (float) (i15 - round4), this.mPaint);
                }
                if (round2 > 0) {
                    canvas.drawRect((float) (i6 + round), (float) i7, (float) i14, (float) (i7 + round2), this.mPaint);
                }
                if (round3 > 0) {
                    canvas.drawRect((float) (i14 - round3), (float) (i7 + round2), (float) i14, (float) i15, this.mPaint);
                }
                if (round4 > 0) {
                    canvas.drawRect((float) i6, (float) (i15 - round4), (float) (i14 - round3), (float) i15, this.mPaint);
                }
            }
        }
    }
