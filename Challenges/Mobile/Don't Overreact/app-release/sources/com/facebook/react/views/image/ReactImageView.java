    ...
    public void setShouldNotifyLoadEvents(boolean z) {
        if (!z) {
            ...
            this.mDownloadListener = new ReactImageDownloadListener<ImageInfo>() {
                ...
                @Override // com.facebook.drawee.controller.ControllerListener, com.facebook.react.views.image.ReactImageDownloadListener
                ...
                if (imageSource != null) {
                    ...
                    if (!isTiled() || (getWidth() > 0 && getHeight() > 0)) {
                        ...
                        if (reactImageDownloadListener2 != null) {
                            genericDraweeHierarchy.setProgressBarImage(reactImageDownloadListener2);
                        }
